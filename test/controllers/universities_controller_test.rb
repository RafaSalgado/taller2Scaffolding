...
class UniversitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create university" do
    assert_difference('University.count') do
      post universities_url, params: { university: { carrera: @university.carrera, nombre_universidad: @university.nombre_universidad, porcentaje: @university.porcentaje, semestre: @university.semestre, string: @university.string } }
    end
  ...
  test "should update university" do
    patch university_url(@university), params: { university: { carrera: @university.carrera, nombre_universidad: @university.nombre_universidad, porcentaje: @university.porcentaje, semestre: @university.semestre, string: @university.string } }
